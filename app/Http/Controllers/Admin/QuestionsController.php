...
class QuestionsController extends Controller
{
    //
    //
    protected $viewPath = 'Admin.questions';
    private $route = 'questions';
    ...
    public function datatable(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->addColumn('actions', function ($row) {
                $actions = ' <a href="' . url( "/question-comments/index/" . $row->id) . '" class="btn btn-active-light-info">' . '<i class="bi bi-building"></i>  </a>';
                return $actions;

            })
            ->rawColumns(['actions', 'checkbox', 'status','user_name'])
            ->make();
